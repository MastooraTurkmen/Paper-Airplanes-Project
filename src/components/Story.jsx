...
const Story = () => {
  return (
    <div className="text-xl bg-[#1D1E2F] overflow-hidden w-full flex flex-col justify-center mx-auto lg:px-20 px-10 py-10 mb-20 mt-[40px] md:mt-[70px]">
      <div className="flex items-center justify-center mx-auto flex-wrap-reverse lg:flex-nowrap gap-3 relative">
        ...
        <div className="content w-[370px]  md:w-[500px] h-auto lg:h-full p-4 pt-7 md:flex mx-auto relative text-white">
          <div className="flex flex-col items-start gap-3">
            <h1 className="text-[#E87900] md:text-lg text-md font-semibold">Our Story</h1>
            <p className="lg:text-3xl text-3xl text-start font-semibold mt-3 w-full">From Refugee to Executive Director</p>
      ...
      <div className="vision-mission flex flex-wrap lg:flex-nowrap gap-7 lg:gap-3 mt-[150px] justify-start md:justify-center lg:justify-between mx-auto text-white text-start">
        <div className="mission p-7 lg:p-5 relative w-full md:w-[500px] lg:w-[400px]">
          <img src={rect1} alt="Rectangle 1" className="w-full h-full absolute z-10 top-0 md:top-[-20px] left-0" />
          <h1 className="font-semibold md:text-3xl text-xl">Our Mission</h1>
          <p className="md:text-base text-xs lg:text-sm font-light mt-5">We empower individuals impacted by conflict through education and skills training, fostering empowerment and inclusivity.</p>
        </div>
        <div className="vision p-7 lg:p-5 relative w-full md:w-[500px] lg:w-[400px]">
          <img src={rect2} alt="Rectangle 2" className="w-full h-full absolute z-10 top-0 md:top-[-20px] left-0 md:left-[-20px]"/>
          <h1 className="font-semibold md:text-3xl text-xl">Our Vision</h1>
          <p className="md:text-base text-xs lg:text-sm font-light mt-5 h-20">We envision a world where everyone affected by conflict has equal access to education enabling them to thrive and contribute to society.</p>
        </div>
      </div>
    </div>
  );
